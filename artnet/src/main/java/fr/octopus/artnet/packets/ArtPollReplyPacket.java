...
package fr.octopus.artnet.packets;

import java.net.InetAddress;
import java.net.UnknownHostException;
import java.util.logging.Level;

import fr.octopus.artnet.NodeReportCode;
import fr.octopus.artnet.NodeStyle;
import fr.octopus.artnet.PortDescriptor;
...
public class ArtPollReplyPacket extends ArtNetPacket {
    ...
    /**
     * @param dmxIns the dmxIns to set
     */
    ...
    /**
     * @param dmxOuts the dmxOuts to set
     */
